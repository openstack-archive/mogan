...
dictionary that including the information we want to send out. The format is
following::
...
The versioned notification is concept that defines a base frame for general
...
objects. Instead of that using the register_notification decorator on every
