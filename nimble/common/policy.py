...
instance_policies = [
    policy.RuleDefault('baremetal:instance:get',
                       'rule:is_admin or rule:is_observer',
                       description='Retrieve Instance records'),
    policy.RuleDefault('baremetal:instance:get_states',
                       'rule:is_admin or rule:is_observer',
                       description='View Instance power and provision state'),
    policy.RuleDefault('baremetal:instance:create',
                       'rule:is_admin',
                       description='Create Instance records'),
    policy.RuleDefault('baremetal:instance:delete',
                       'rule:is_admin',
                       description='Delete Instance records'),
    policy.RuleDefault('baremetal:instance:update',
                       'rule:is_admin',
                       description='Update Instance records'),
    policy.RuleDefault('baremetal:instance:set_power_state',
                       'rule:is_admin',
