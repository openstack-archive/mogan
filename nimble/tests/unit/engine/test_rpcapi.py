...
#    under the License.
"""
Unit Tests for :py:class:`nimble.engine.rpcapi.EngineAPI`.
"""
...
from nimble.engine import manager as engine_manager
...
from nimble.tests.unit.db import utils as dbutils
...
class RPCAPITestCase(base.DbTestCase):
    ...
    def test_instance_states(self):
        self._test_rpcapi('instance_states',
                          'call',
                          version='1.0',
                          instance=self.fake_instance_obj)
