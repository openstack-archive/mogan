...
@mock.patch.object(manager.EngineManager, '_sync_node_resources')
class ManageInstanceTestCase(mgr_utils.ServiceSetUpMixin,
                             tests_db_base.DbTestCase):

    @mock.patch.object(ironic, 'set_power_state')
    def test_change_instance_power_state(self, set_power_mock, mock_sync):
    ...
    def test_get_instance__states(self, get_states_mock, mock_sync):
        instance = obj_utils.create_test_instance(self.context)
