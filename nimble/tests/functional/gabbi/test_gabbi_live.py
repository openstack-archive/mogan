...
"""
A test module to exercise the Nimble API with gabbi.
...
def load_tests(loader, tests, pattern):
    ...
    nimble_url = os.getenv('NIMBLE_SERVICE_URL')
    if nimble_url:
        parsed_url = urlparse.urlsplit(nimble_url)
        ...
        raise RuntimeError('NIMBLE_SERVICE_URL is not set')
