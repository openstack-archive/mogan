...
class TestInstances(v1_test.APITestV1):
    ...
    def setUp(self):
        ...
        self.useFixture(mockpatch.Patch('nimble.engine.rpcapi.EngineAPI',
                                        return_value=self.rpc_api))
        self.image_api = mock.Mock()
        self.useFixture(mockpatch.Patch('nimble.image.api.API',
    ...
    def _prepare_instance(self, amount, mocked):
        ...
        for i in six.moves.xrange(amount):
            test_body = {
                ...
                'networks': [{'net_id': 'c1940655-8b8e-4370-b8f9-03ba1daeca31'}],
