...
from nimble.api.metadata import base
from nimble import cache_utils
import nimble.conf
from nimble import context as nimble_context
from nimble import exception
from nimble.i18n import _
from nimble.i18n import _LE
from nimble.i18n import _LW
from nimble.network.neutronv2 import api as neutronapi
from nimble import wsgi
...
class MetadataRequestHandler(wsgi.Application):
    ...
    def _get_instance_id_from_lb(self, provider_id, instance_address):
        ...
        context = nimble_context.get_admin_context()
