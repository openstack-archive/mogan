...
def get_injected_network_template(network_info, use_ipv6=None, template=None,
    ...
    :param network_info:
        :py:meth:`~nimble.network.manager.NetworkManager.get_instance_nw_info`
    ...
    for vif in network_info:
        ...
        if subnet_v4:
            ...
            if subnet_v4['ips']:
                ip = subnet_v4['ips'][0]
                address = ip['address']
                netmask = get_netmask(ip, subnet_v4)
        ...
        if have_ipv6:
            ...
            if subnet_v6['ips']:
                ...
                netmask_v6 = get_netmask(ip_v6, subnet_v6)
...
def get_network_metadata(network_info, use_ipv6=None):
    ...
    :param network_info: `nimble.network.models.NetworkInfo` object describing
        the network metadata.
    :param use_ipv6: If False, do not return IPv6 template information
        even if an IPv6 subnet is present in network_info. Defaults to
        nimble.netconf.use_ipv6.
    """
    if not network_info:
        return
