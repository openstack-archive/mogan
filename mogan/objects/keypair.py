...
from mogan.db.sqlalchemy import api as db_api
...
@base.MoganObjectRegistry.register
class KeyPairList(object_base.ObjectListBase, object_base.ObjectListBase):
    # Version 1.0: Initial version
    VERSION = '1.0'
    ...
    @classmethod
    def get_count_from_db(context, user_id):
