...
class ConfigDriveBuilder(object):
    ...
    def make_drive(self, path):
        ...
        with utils.tempdir() as tmpdir:
            ...
            # (NOTE) mogan may not support iso9660, need check.
...
def required_by(instance):
    # FIXME(Shaohe) always enable config_drive at present.
    # no need config option.
    # no need to enable it by API.
    # ignore img_config_drive. Some image has a img_config_drive attr.
    # please come into glance repo and $ git show 5601f7f
    return True


# mogan has not support this, we can extend this later.
