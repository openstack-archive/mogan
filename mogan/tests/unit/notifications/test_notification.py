...
from mogan.objects import server as inst_obj
...
notification_object_data = {
    'ServerPayload': '1.0-e0f5f1a93307435bff6ccb1b69d66003',
    'ServerActionPayload': '1.0-406ba4240e7dc166a10069484397c3e1',
...
class TestServerActionNotification(test_base.TestCase):
    ...
    def test_send_version_server_action(self, mock_emit):
        ...
        fake_inst_values = db_utils.get_test_server()
        server = inst_obj.Server(**fake_inst_values)
        ...
        self.assertEqual(fake_inst_values['flavor_uuid'],
                         payload['flavor_uuid'])
