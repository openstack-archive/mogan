...
class DbServerGroupTestCase(base.DbTestCase):
    ...
    def test_server_group_create(self):
        ...
        self.assertEqual(['policy1', 'policy2'], self.server_group.policies)
        self.assertEqual(['server1', 'server2'], self.server_group.members)
    ...
    def test_server_group_get(self):
        ...
        self.assertEqual(['policy1', 'policy2'], server_group.policies)
        self.assertEqual(['server1', 'server2'], server_group.members)
    ...
    def test_server_group_update(self):
        ...
        self.assertEqual('fake_user_id', server_group.user_id)
        self.assertEqual('fake_project_id', server_group.project_id)
        self.assertEqual(['policy2', 'policy3'], server_group.policies)
        self.assertEqual(['server2', 'server3'], server_group.members)
    ...
    def test_server_group_get_all(self):
        ...
        self.assertEqual(['policy1', 'policy2'], server_groups[0].policies)
        self.assertEqual(['server1', 'server2'], server_groups[0].members)
