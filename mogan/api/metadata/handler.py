...
from mogan.api.metadata import base
from mogan import cache_utils
from mogan.common.i18n import _
from mogan.common.i18n import _LE
from mogan.common.i18n import _LW
import mogan.conf
from mogan import context as mogan_context
from mogan import exception
from mogan.network.neutronv2 import api as neutronapi
from mogan import wsgi
...
class MetadataRequestHandler(wsgi.Application):
    ...
    def _get_instance_id_from_lb(self, provider_id, instance_address):
        ...
        context = mogan_context.get_admin_context()
