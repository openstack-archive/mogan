...
class API(object):
    ...
    def detach_interface(self, context, server, port_id):
        ...
        self.unbind_ports(context, client, port_id=interface['id'])
        self.change_instace_nw_info(context, server, port_id)
        self.ironic_driver.unplug_vifs(context, server)
    ...
    def unbind_ports(self, context, client, port_id):
    ...
    def change_instace_nw_info(self, context, server, port_id):
