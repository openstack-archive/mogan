...
STABLE_STATES = (ACTIVE, ERROR, DELETED, STOPPED, MAINTENANCE, UNKNOWN)
...
# All states are allowed to transition to DELETED nad ERROR
for state in (STABLE_STATES + UNSTABLE_STATES):
...
machine.add_transition(ACTIVE, MAINTENANCE, 'maintain')

# from stopped* states
machine.add_transition(STOPPED, POWERING_ON, 'start')
machine.add_transition(STOPPED, REBUILDING, 'rebuild')
machine.add_transition(STOPPED, MAINTENANCE, 'maintain')

# from error* states
machine.add_transition(ERROR, MAINTENANCE, 'maintain')

# from maintenance* states
machine.add_transition(MAINTENANCE, ACTIVE, 'done')
