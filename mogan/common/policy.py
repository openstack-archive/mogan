...
server_policies = [
    ...
    policy.RuleDefault('mogan:server:set_power_state',
                       'rule:default',
                       description='Perform the power action on an server'),
    ...
    policy.RuleDefault('mogan:server:associate_floatingip',
                       'rule:default',
                       description='Associate a floating ip with an server'),
    ...
    policy.RuleDefault('mogan:server:set_lock_state',
                       'rule:default',
                       description='Lock/UnLock an server'),
    policy.RuleDefault('mogan:server:set_provision_state',
                       'rule:default',
                       description='Set the provision state of an server'),
    policy.RuleDefault('mogan:server:get_serial_console',
                       'rule:default',
                       description='Get serial console for an server'),
